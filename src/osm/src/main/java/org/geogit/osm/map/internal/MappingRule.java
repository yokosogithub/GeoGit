...
public class MappingRule {
    ...
    public MappingRule(String name, Map<String, List<String>> filter, Map<String, FieldType> fields) {
    ...
    private Class<?> getCompatibleClass(FieldType fieldType) {
        return fieldType.getBinding();
    }
