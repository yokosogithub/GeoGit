...
public class OSMUnmapOp extends AbstractGeoGitOp<RevTree> {
    ...
    private static final int NODE_TAGS_FIELD_INDEX = 3;

    private static final int NODE_TIMESTAMP_FIELD_INDEX = 2;

    private static final int NODE_VERSION_FIELD_INDEX = 1;

    private static final int NODE_CHANGESET_FIELD_INDEX = 4;

    private static final int NODE_LOCATION_FIELD_INDEX = 6;

    // from OSMUtils.wayType():
    ...
    private static final int WAY_TAGS_FIELD_INDEX = 3;

    private static final int WAY_TIMESTAMP_FIELD_INDEX = 2;

    private static final int WAY_VERSION_FIELD_INDEX = 1;

    private static final int WAY_CHANGESET_FIELD_INDEX = 4;
