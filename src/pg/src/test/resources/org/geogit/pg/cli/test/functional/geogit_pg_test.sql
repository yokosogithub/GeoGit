...
ALTER TABLE public.geogit_pg_test OWNER TO postgres;

INSERT INTO geogit_pg_test (gid, geom, name) VALUES
...
ALTER TABLE ONLY geogit_pg_test
    ADD CONSTRAINT geogit_pg_test_pkey PRIMARY KEY (gid);