...
public class RemoteRepositoryFactory {
    ...
    /**
     * Create a remote repository connection to the parameter location string, if its a local
     * repository (i.e. can be reached on the local machines addressable drives return a
     * {@link LocalRemote} else if it is remotely accessible via the network expect a {@link Remote}
     * object
     * 
